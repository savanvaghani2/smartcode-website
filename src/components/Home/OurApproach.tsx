        ...
        <div class={'flex justify-center items-center'}>
            <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20 lg:pb-20 mx-auto">
                ...
                <div className=" mb-10 lg:mb-14">
                    ...
                    <p className="mt-1 text-neutral-400">This profound insight guides our comprehensive strategy — from
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
                    ...
                    <div>
                        ...
                        <div className="flex gap-x-5 ms-1">
                            ...
                            <div
                                className="relative last:after:hidden after:absolute after:top-8 after:bottom-0 after:start-4 after:w-px after:-translate-x-[0.5px] after:bg-neutral-800">
                                <div className="relative z-10 size-8 flex justify-center items-center">
              <span
                  className="flex flex-shrink-0 justify-center items-center size-8 border border-neutral-800 text-[#ff0] font-semibold text-xs uppercase rounded-full">
                1
              </span>
                                </div>
                            </div>
